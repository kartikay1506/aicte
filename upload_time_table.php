			...
			<div class="card-body">
				<div class="card">
					<div class="card-header">
						<i class="fa fa-reorder" style="margin-right: 5px"></i>Upload Time Table
					</div>
					<form id="upload-time-table" method="post" enctype="multipart/form-data">
						<div class="card-body">
							<table class="table table-bordered">
										<thead>
											<tr>
												<th style="width: 13vw">Year</th>
												<th style="width: 13vw">Semester</th>
												<th style="width: 18vw">Section</th>
												<th>Proof</th>
												<th>Settings</th>
											</tr>
										</thead>
