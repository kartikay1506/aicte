			...
			<div class="card-body">
				<div class="card">
					<div class="card-header">
						<i class="fa fa-reorder" style="margin-right: 5px"></i>AICTE Feedback
					</div>
					<div class="card-body">
						...
						<div class="card" style="height: 95%">
								...
								<div class="card-body">
									...
									<select class="form-control" name="comment_8" id="">
											...
											<option value="1">Syllabus not appropriate</option>
											<option value="2">Technical resources not sufficient</option>
