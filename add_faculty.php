	  	...
	  	<div class="card-body">
			<div class="card">
					...
					<div style="margin-left: 15px">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								...
								<input type="date" name="facultyDateOfJoining" class="form-control" placeholder="dd/mm/yyyy">
							</div>
						</div>
				...
				<div class="card-footer">
					<button class="btn btn-sm btn-primary" name="addFaculty" style="margin-right: 5px"><i class="fa fa-check" style="margin-right: 5px"></i>Submit</button>
